...
Thank you for your interest in contributing to **appz** ("the Project"),
...
then-current open-source license (the Apache License, Version 2.0). The
additional rights granted to the Maintainer in Sections 2 and 3 exist
**alongside**, and do not diminish, that public license. The free and
open-source distribution of appz for individual developers is and remains
