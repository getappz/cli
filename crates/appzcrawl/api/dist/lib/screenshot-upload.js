 ...
 */
export async function uploadScreenshotToR2(bucket, buffer, contentType) {
...
export function screenshotKeyFromFilename(filename) {
    return `${SCREENSHOT_PREFIX}/${filename}`;
}
//# sourceMappingURL=screenshot-upload.js.map