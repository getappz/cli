...
describe("WebCrawler", () => {
    ...
    const mockRobotsParser = robotsParser;
    let maxCrawledDepth;
    beforeEach(() => {
        // Setup default mocks
    ...
    it("should filter subdomain URLs with includePaths when allowSubdomains is true", async () => {
        ...
        // Verify denied links
        expect(filteredLinks.denialReasons.has("https://example.com/blog")).toBe(true);
        expect(filteredLinks.denialReasons.has("https://sub.example.com/about")).toBe(true);
        expect(filteredLinks.denialReasons.has("https://other.example.com/contact")).toBe(true);
    });
    it("should filter subdomain URLs with includePaths using regexOnFullURL", async () => {
        ...
        // Verify denied links
        expect(filteredLinks.denialReasons.has("https://example.com/pricing/details")).toBe(true);
        expect(filteredLinks.denialReasons.has("https://sub.example.com/blog")).toBe(true);
    });
});
