...
const mapUndiciError = (url, skipTlsVerification, e) => {
...
export async function fetchFileToBuffer(url, skipTlsVerification = false, init) {
    try {
...
export async function downloadFile(id, url, skipTlsVerification = false, init) {
