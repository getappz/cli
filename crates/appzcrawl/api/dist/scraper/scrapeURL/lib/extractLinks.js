...
import { extractLinks as _extractLinks, extractBaseHref as _extractBaseHref, } from "@mendable/firecrawl-rs";
function resolveUrlWithBaseHref(href, baseUrl, baseHref) {
    ...
    try {
        ...
        logger.error(`Failed to construct URL for href: ${href} with base: ${resolutionBase}`, { error });
        return "";
    }
}
