 ...
 */
export function buildScrapeRunnerOptions(scrapeOpts) {
    if (!scrapeOpts) {
        return {
    ...
    return {
        ...
        maxAge: scrapeOpts.maxAge !== undefined
            ? scrapeOpts.maxAge
            : SCRAPE_DEFAULTS.maxAge,
        storeInCache: scrapeOpts.storeInCache !== undefined
 ...
 */
export function buildScrapeRunnerOptionsFromQueue(opts) {
    if (!opts) {
        return {
            onlyMainContent: true,
            maxAge: SCRAPE_DEFAULTS.maxAge,
 ...
 */
export function buildScrapeOptsForQueue(scrapeOpts) {
    if (!scrapeOpts)
        return undefined;
    return {
...
//# sourceMappingURL=scrape-options.js.map