...
export declare enum RateLimiterMode {
    Crawl = "crawl",
...
export declare const UNSUPPORTED_SITE_MESSAGE = "This site is not supported. Please check the blocklist or contact support.";
/**
...
export interface AppzcrawlEngineRpc {
    ...
    rpc_extract_assets(html: string, base_url: string, formats_json: string): string;
    rpc_post_process_markdown(markdown: string, base_url: string, citations: boolean): string;
