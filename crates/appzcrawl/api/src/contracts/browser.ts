...
export type BrowserCreateRequestInput = z.input<
  typeof browserCreateRequestSchema
>;
...
export type BrowserCreateResponse =
  | BrowserCreateResponseSuccess
  | BrowserCreateResponseError;
...
export const browserExecuteRequestSchema = z
  ...
  .refine(
    (data) =>
      data.code !== undefined || (data.actions && data.actions.length > 0),
    {
...
export type BrowserExecuteRequestInput = z.input<
  typeof browserExecuteRequestSchema
>;
...
export type BrowserExecuteResponse =
  | BrowserExecuteResponseSuccess
  | BrowserExecuteResponseError;
...
export type BrowserDeleteRequestInput = z.input<
  typeof browserDeleteRequestSchema
>;
...
export type BrowserDeleteResponse =
  | BrowserDeleteResponseSuccess
  | BrowserDeleteResponseError;
...
export type BrowserStatusResponse =
  | BrowserStatusResponseSuccess
  | BrowserStatusResponseError;
...
export function parseBrowserCreateRequest(
  raw: unknown,
): { ok: true; data: BrowserCreateRequest } | { ok: false; error: string } {
...
export function parseBrowserExecuteRequest(
  raw: unknown,
): { ok: true; data: BrowserExecuteRequest } | { ok: false; error: string } {
...
export function parseBrowserDeleteRequest(
  raw: unknown,
): { ok: true; data: BrowserDeleteRequest } | { ok: false; error: string } {
